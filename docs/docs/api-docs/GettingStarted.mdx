...
1. [.NET 10 SDK or higher](https://dotnet.microsoft.com/en-us/download) - You need to have the .NET SDK installed.
...
3. IDE with F# support. My personal recommendation is [Visual Studio Code](https://code.visualstudio.com/) with the [Ionide-fsharp](https://marketplace.visualstudio.com/items?itemName=Ionide.Ionide-fsharp) extension or [JetBrains Rider](https://www.jetbrains.com/rider/).
