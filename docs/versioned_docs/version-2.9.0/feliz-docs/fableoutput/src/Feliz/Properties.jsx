...
import { length, ofArray, map } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/List.js";
import { milliseconds, seconds, minutes, hours } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/TimeSpan.js";
import { map as map_1 } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/Seq.js";
...
export function PropHelpers_dateTimeValueFunc(value, includeTime) {
    if (value != null) {
        const date = value;
        if (includeTime) {
            return toString(date, "yyyy-MM-ddThh:mm");
        }
        else {
