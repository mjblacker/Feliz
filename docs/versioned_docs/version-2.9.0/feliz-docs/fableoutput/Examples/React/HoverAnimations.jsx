...
import { singleton, append, delay, toList } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/Seq.js";
import { fromMilliseconds } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/TimeSpan.js";
import { join } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/String.js";
import { ofArray, singleton as singleton_1 } from "../../fable_modules/fable-library-js.5.0.0-alpha.13/List.js";
...
export function AnimationsOnHover(animationsOnHoverInputProps) {
    ...
    const hovered = patternInput[0];
    return reactElement("div", {
        style: createObj(toList(delay(() => append(singleton(["padding", 10]), delay(() => append(singleton(["transitionDuration", fromMilliseconds(1000) + "ms"]), delay(() => append(singleton(["transitionProperty", join(",", ["background-color", "color"])]), delay(() => (hovered ? append(singleton(["backgroundColor", "#ADD8E6"]), delay(() => singleton(["color", "#000000"]))) : append(singleton(["backgroundColor", "#32CD32"]), delay(() => singleton(["color", "#FFFFFF"]))))))))))))),
        onMouseEnter: (_arg) => {
            setHovered(true);
        },
        onMouseLeave: (_arg_1) => {
