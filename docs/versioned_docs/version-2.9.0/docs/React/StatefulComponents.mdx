...
import MultipleVariables from '../../feliz-docs/fableoutput/Examples/React/MultipleStateVariables'
import RawMultipleVariables from '!!raw-loader!../../feliz-docs/Examples/React/MultipleStateVariables.fs'

<ComponentRender code={RawMultipleVariables}> 
  <MultipleVariables />
</ComponentRender>
